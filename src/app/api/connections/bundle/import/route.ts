...
export async function POST(request: Request) {
  try {
    const body = (await request.json()) as { bundle?: unknown; indices?: unknown; passphrase?: unknown; replaceAll?: unknown };
    ...
    const connections = importBundle(bundle, indices, body.passphrase, body.replaceAll === true);
