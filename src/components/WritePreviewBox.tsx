    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
      ...
      <pre
        ...
        style={{
          ...
          color: current?.error ? "var(--env-prod-fg)" : "#4b473f",
        }}
      >
        {!current ? t("writePreview.loading") : current.error ? t("writePreview.error", { message: current.error }) : current.preview?.sql || t("writePreview.nothing")}
      </pre>
    </div>
  );
}
